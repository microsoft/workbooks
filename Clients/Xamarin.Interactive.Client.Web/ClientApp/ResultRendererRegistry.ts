...
import LoginRendererFactory from "./renderers/LoginRenderer";
...
export class ResultRendererRegistry {
    ...
    getRenderers(result: CodeCellResult): ResultRenderer[] {
        if (result.isNullResult) return [new NullRenderer()];
        else if (
            result.resultRepresentations &&
    ...
    static createDefault(): ResultRendererRegistry {
        ...
        registry.register(LoginRendererFactory);
