...
namespace Xamarin.MSBuild
{
    public class ProcessPolicheckXml : Task
    {
        ...
        static readonly HashSet<int> ExcludedTerms = new HashSet<int> {
            80137,  // "race"  http://policheck.azurewebsites.net/Pages/TermInfo.aspx?LCID=9&TermID=80137
            209526, // "metro" http://policheck.azurewebsites.net/Pages/TermInfo.aspx?LCID=127&TermID=209526
            211972, // "edge"  http://policheck.azurewebsites.net/Pages/TermInfo.aspx?LCID=127&TermID=211972
        };
